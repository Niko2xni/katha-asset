-- CreateEnum
CREATE TYPE "Role" AS ENUM ('CUSTOMER', 'CREATOR');
...
CREATE TABLE "Product" (
    ...
    "pricePhpInCents" INTEGER NOT NULL,
    "priceUsdInCents" INTEGER NOT NULL,
    "previewUrl" TEXT NOT NULL,
    "secureFileUrl" TEXT NOT NULL,
    "tags" TEXT[],
...
CREATE TABLE "Order" (
    ...
    "amountPhpInCents" INTEGER NOT NULL,
    "amountUsdInCents" INTEGER NOT NULL,
