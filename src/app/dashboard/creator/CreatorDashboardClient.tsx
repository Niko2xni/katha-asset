            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-[1.6rem] text-neutral-500">
                        Manage your assets, track real-time analytics, and expand your catalog.
                    </p>
                </div>
                <Link
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className="bg-white border border-neutral-200 shadow-sm">
                    ...
                    <CardContent>
                        ...
                        <p className="text-[1.2rem] text-neutral-400 mt-1">Calculated in Philippine Pesos</p>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-white border border-neutral-200 shadow-sm">
                    ...
                    <CardContent>
                        ...
                        <p className="text-[1.2rem] text-neutral-400 mt-1">Calculated in US Dollars</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="bg-white border border-neutral-200 rounded-xl p-8 shadow-sm flex flex-col justify-between">
                    <div>
                        ...
                        <p className="text-[1.3rem] text-neutral-400 mb-8">
                            Visual breakdown of total sales metrics per published resource asset.
                        </p>
                    </div>
                                    ...
                                    <div key={asset.id} className="space-y-2">
                                        <div className="flex justify-between items-center text-[1.3rem]">
                                            ...
                                            <span className="font-semibold text-neutral-500 font-mono">
                                                {asset.sales} Sales ({formatPrice(asset.sales * asset.pricePhpInCents, asset.sales * asset.priceUsdInCents)})
                                            </span>
                                        </div>
                                        {/* Chart Bar */}
                ...
                <div className="bg-white border border-neutral-200 rounded-xl p-8 shadow-sm">
                    ...
                    <p className="text-[1.3rem] text-neutral-400 mb-6">
                        Active resource index mapping rates, pricing metrics, and overall reviews.
                    </p>
                        ...
                        <table className="w-full text-left text-[1.3rem]">
                            <thead>
                                <tr className="border-b border-neutral-200 pb-4 text-neutral-400 font-bold">
                                    ...
                                    <th className="pb-3 pr-4 font-semibold text-right">Price (PHP)</th>
                            ...
                            <tbody className="divide-y divide-neutral-100">
                                {assets.map((asset) => (
                                    <tr key={asset.id} className="text-neutral-700">
                                        <td className="py-3 pr-4 font-bold max-w-[180px] truncate">{asset.title}</td>
                                        <td className="py-3 pr-4">
                                            <div className="flex items-center gap-1">
                                                <svg className="w-[1.2rem] h-[1.2rem] fill-amber-400 text-amber-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>
                                                <span className="font-mono font-bold text-neutral-600">{asset.rating.toFixed(1)}</span>
                                            </div>
                                        </td>
