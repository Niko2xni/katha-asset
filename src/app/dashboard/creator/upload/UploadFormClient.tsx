  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
      ...
      <form
        ...
        className="lg:col-span-7 bg-white border border-neutral-200 rounded-xl p-8 space-y-6 shadow-sm"
      >
        <div className="border-b border-neutral-100 pb-4">
          <h2 className="text-[2.0rem] font-bold text-neutral-900">
            Resource Registration
          </h2>
          <p className="text-[1.3rem] text-neutral-500">
            Provide official details to register this digital asset on
            KathaMarket.
          </p>
        </div>
        ...
        <div className="space-y-4 text-[1.3rem]">
          <div className="space-y-1">
            <label className="text-neutral-500 font-bold block">
              Asset Title
            </label>
            <input
              type="text"
          ...
          <div className="space-y-1">
            <label className="text-neutral-500 font-bold block">
              Secure Storage File Path (Cloud Bucket Folder)
            </label>
            <input
              type="text"
              value={secureFileUrl}
