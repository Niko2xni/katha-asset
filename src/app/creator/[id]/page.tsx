                    ...
                    <div className="text-center sm:text-left space-y-4">
                        <div className="space-y-1">
                            ...
                            <p className="text-[1.4rem] text-neutral-400">
                                Member since: {new Date(creator.createdAt).toLocaleDateString("en-US", {
                                    year: 'numeric',
                                    month: 'long',
                                    day: 'numeric'
                                })}
                        ...
                        <div className="flex items-center justify-center sm:justify-start gap-8 pt-2">
                            <div>
                                <span className="block text-[2.2rem] font-extrabold tracking-tight">{products.length}</span>
                                <span className="block text-[1.2rem] text-neutral-400 uppercase font-semibold tracking-wider">Published Assets</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <main className="max-w-[1200px] w-full mx-auto px-8 py-16 flex-1">
                <div className="mb-10">
                    ...
                    <p className="text-[1.5rem] text-neutral-500 mt-1">
                        Browse all premium developer products published by {creator.name || "this creator"}.
                    </p>
                </div>
