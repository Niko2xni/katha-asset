      ...
      <section className="relative overflow-hidden bg-neutral-950 text-white py-24 sm:py-32">
        ...
        <div className="relative max-w-[1200px] mx-auto px-8 flex flex-col items-center text-center">
          ...
          <h1 className="text-[3.6rem] sm:text-[5.4rem] font-black tracking-tight max-w-[800px] leading-[1.1] mb-6">
            Discover Premium{" "}
            <span className="bg-gradient-to-r from-neutral-200 via-neutral-400 to-neutral-100 bg-clip-text text-transparent">
              Digital Assets
            </span>{" "}
            for Developers
          </h1>
          ...
          <p className="text-[1.6rem] sm:text-[1.8rem] text-neutral-400 max-w-[640px] mb-10 leading-relaxed">
            Access top-tier production-ready boilerplate, custom components,
            design templates, and packages crafted by industry experts.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-white p-8 rounded-xl border border-neutral-200 shadow-sm space-y-4">
              ...
              <h3 className="text-[1.8rem] font-bold text-neutral-900">
                Instant Access
              </h3>
              <p className="text-[1.4rem] text-neutral-600 leading-relaxed">
                Get immediate access to secure, private downloads inside your
                asset vault immediately after checking out through Paymongo.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl border border-neutral-200 shadow-sm space-y-4">
              ...
              <p className="text-[1.4rem] text-neutral-600 leading-relaxed">
                Our platform integrates with Supabase Secure Storage buckets to
                ensure asset binaries are only decrypted and delivered to
                verified purchasers.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl border border-neutral-200 shadow-sm space-y-4">
              ...
              <h3 className="text-[1.8rem] font-bold text-neutral-900">
                AI-Optimized Details
              </h3>
              <p className="text-[1.4rem] text-neutral-600 leading-relaxed">
                Creators leverage our specialized AI integration layers to
                optimize listing copywriting and structure clear technical
                descriptions.
              </p>
            </div>
          </div>
      ...
      <footer className="border-t border-neutral-200 bg-white py-12">
        <div className="max-w-[1200px] mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-[1.3rem] text-neutral-400">
            © {new Date().getFullYear()} KathaMarket. All rights reserved.
            Premium digital commerce portal.
          </p>
        </div>
      </footer>
    </div>
