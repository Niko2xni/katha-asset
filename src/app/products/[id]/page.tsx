    ...
    <div className="flex items-center gap-1">
      {Array.from({ length: 5 }).map((_, i) => {
        ...
        return (
          <svg
            key={i}
            className="w-6 h-6 text-neutral-300 fill-neutral-300"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
            <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
      ...
      <span className="text-[1.4rem] text-neutral-500 font-bold ml-2">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex flex-wrap gap-2">
                  {product.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-[1.2rem] bg-neutral-200/60 px-3 py-1 rounded-md text-neutral-600 font-semibold"
                    >
                      #{tag}
                    </span>
                  ))}
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                <div>
                  <span className="text-[1.2rem] text-neutral-400 block font-semibold uppercase tracking-wider">
                    Creator
                  </span>
                  <Link
            ...
            <div className="space-y-3">
              <h3 className="text-[1.6rem] font-extrabold text-neutral-900">
                Description
              </h3>
            ...
            <div className="bg-white border border-neutral-200 rounded-2xl p-8 shadow-sm space-y-6">
              <div className="flex flex-col">
                <span className="text-[1.2rem] text-neutral-400 font-bold uppercase tracking-wider mb-1">
                  Price
                </span>
                <PriceDisplay
                  phpInCents={product.pricePhpInCents}
                  usdInCents={product.priceUsdInCents}
                />
              </div>
              ...
              <div className="space-y-3 text-[1.2rem] text-neutral-500 border-t border-neutral-100 pt-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Processed with PayMongo gateway (GCash, Maya, Cards, QRph)
                  </span>
                </div>
              </div>
            </div>
